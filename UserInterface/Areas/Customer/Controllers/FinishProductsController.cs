...
namespace UserInterface.Areas.Customer.Controllers
{
    ...
    public class FinishProductsController : Controller
    {
        ...
        //-------------------------------GET LIST------------------------------------
        public IActionResult RedirectToFinishProductionList(int brandFK, int mainSectionId)
        {
        ...
        //============================================================================
        public IActionResult PrintFinishFood(int id, int brandfk, int mainSectionId)
        {
            ...
            model.tredMaeketReadyfoodVM = _unitOfWork.TredMarketRepository.Get(u => u.BrandID == brandfk);
            ...
            model.ReadyFoodLoginVMlist = _unitOfWork.readyFoodRepository.GetAll(incloudeProperties: "Brand").Where(u => u.BrandFK == brandfk).ToList();
            model.MainsectionVMlist = _unitOfWork.MainsectionRepository.GetAll().Where(u => u.BrandFK == brandfk).ToList();

            return new ViewAsPdf("PrintFinishFood", model)
            {
